                ...
                <v-col cols="3" class="pt-6 pb-0" v-show="cbt.nombre=='Pedidos'">
                  <v-tooltip bottom>
                    <template v-slot:activator="{ on }">
                      <v-btn
                        icon small outlined
                        @click="pedidosFacturadosAEmbalaje" v-on="on">
                        <v-icon>
                          {{'mdi-file-plus'}}
                        </v-icon>
                      </v-btn>
                    </template>
                    <span>Enviar Pedidos Facturados a Embalaje</span>
                  </v-tooltip>
                </v-col>
                  ...
                  <v-card-text>
                    <v-container>
                      <v-row>
                        ...
                        <v-col v-show="basadoEnCpr==false" cols="6" sm="6" md="6" class="pt-0 pb-0">
                          <v-autocomplete v-if="editedIndex==-1"
                            ref="cliente"
                        ...
                        <v-col v-show="basadoEnCpr==true" cols="6" sm="6" md="6" class="pt-0 pb-0">
                          <v-text-field
                            disabled
                            v-model="editado.nombre"
                            label="Cliente">
                      ...
                      <v-row>
                        <v-col cols="3" sx="3" mx="3" class="pt-0 pb-0">
                          <v-btn
                        ...
                        <v-col cols="1" sx="1" mx="1" class="pt-0 pb-0">
                      ...
                      <v-row>
                        ...
                        <v-col  cols="4" class="x1 mt-0 pt-0 pl-1 pr-0">
                          <v-text-field v-if="busArt!='TEXTO'"
                        ...
                        <v-col cols="1" class="mt-0 pt-0 pl-1 pr-0">
                          <v-badge
                            ...
                            <v-text-field v-if="editado.cpr.substr(0,3)=='PED'"
                              filled dense label="Cantidad" class="x1"
                              :color="temas.forms_titulo_bg"
                        ...
                        <v-col cols="2" class="mt-0 pt-0 pl-1 pr-0">
                          <v-text-field
                        ...
                        <v-col cols="1" class="mt-0 pt-0 pl-1 pr-0">
                          <v-text-field
                            filled dense label="%Desc." class="x1"
                            :color="temas.forms_titulo_bg"
                        ...
                        <v-col cols="1" class="mt-0 pt-0 pl-1 pr-0">
                          <v-select
                            filled dense label="IVA" class="x2"
                            :color="temas.forms_titulo_bg"
                        ...
                        <v-col cols="12" sx="12" mx="12" class="pt-0 pb-0">
                          <v-data-table
                            ...
                            <template v-slot:item.codigo="{ item }">
                              ...
                              <v-badge
                                inline
                                :content="itemIvaTasa(item.ivatasa)"
                                :color="temas.forms_btn_add_bg"
                            ...
                            <template v-slot:item.cantidad="{ item }">
                              <span
                                class="mini-font">{{ formatoImporte(item.cantidad) }}
                              </span>
                            </template>
                            <template v-slot:item.precio="{ item }">
                              <span
                                class="mini-font">${{ formatoImporte(item.precio) }}
                              </span>
                            </template>
                      ...
                      <v-row>
                        <v-col cols="1" sm="1" md="1" class="pt-4 pb-0">
                        ...
                        <v-col cols="2" sm="2" md="2" class="pt-4 pb-0">
                          <v-text-field class="caption" v-if="editado.cpr!='REM'"
                            dense outlined prefix="$"
                        ...
                        <v-col cols="2" sm="2" md="2" class="pt-4 pb-0">
                          <v-text-field class="totales-font" v-if="editado.cpr!='REM'"
...
-->
                  ...
                  <v-card-text>
                    <v-container>
                      ...
                      <v-row>
                        ...
                        <v-col  cols="5" class="x1 mt-0 pt-0 pl-1 pr-0">
                          <v-text-field
                            filled dense label="Descripción"
                            disabled
                            :color="temas.forms_titulo_bg"
            ...
            <!--// PEDIDOS FACTURADOS A EMBALAJE // -->
            <v-dialog v-model="dialogPedidosAEmbalaje" max-width="950px">
              <template v-slot:activator="{}"></template>
              <v-card>
                <v-toolbar flat
                  :color="temas.forms_titulo_bg"
                  :dark="temas.forms_titulo_dark==true">
                  <v-btn
                    icon @click="cerrarPedidosAEmbalaje"
                    :color="temas.forms_close_bg"
                    :dark="temas.forms_close_dark==true">
                    <v-icon>mdi-arrow-left-circle</v-icon>
                  </v-btn>
                  <span class="text--right pl-5">
                    Enviar Pedidos Facturados a Embalaje
                  </span>
                  <v-spacer></v-spacer>
                  <v-btn v-show="embalajesSel>0"
                    :color="temas.barra_principal_bg"
                    :dark="temas.barra_principal_dark"
                    class="ma-2 white--text" @click="confirmarPedidosAEmbalaje">
                    Confirmar Pedidos Facturados a Embalaje
                    <v-badge
                  ...
                  <v-card-text>
                    <v-container>
                      <v-row>
                        <v-col cols="12" sx="12" mx="12">
                          <v-data-table
                            :headers="headersPedidosAEmbalaje"
                            :items="pedidosAEmbalaje"
                            dense
                            class="elevation-1">
                              ...
                              <v-tooltip bottom>
                                <template v-slot:activator="{ on }">
                                  <v-btn v-show="item.cpr!=null"
                                    ...
                                    @click="seleccionarPedidoAEmbalaje(item)" v-on="on">
            ...
            <!-- FIN DE PEDIDOS FACTURADOS A EMBALAJE -->
                        ...
                        <v-col cols="12" sx="12" mx="12">
                          <v-data-table
                            ...
                            <template v-slot:item.acancelar="{ item }">
                              <span><b>${{ formatoImporte(item.acancelar) }}</b></span>
                            </template>
                              ...
                              <v-tooltip bottom>
                                <template v-slot:activator="{ on }">
                                  <v-btn v-show="reciboDeUnSoloComprobante==false"
                                    fab x-small class="mr-2"
                                    :color=
                                    "item.acancelar==0?temas.cen_btns_bg:temas.cen_card_activo_bg"
                                    :dark="temas.cen_btns_dark==true"
          ...
          <td :colspan="headers.length">
            <v-data-table v-if="filtroComprobanteSel!='Recibos'"
              ...
              <template v-slot:item.articulo.nombre="{ item }">
                <span> {{item.articulo.codigo=='1@1' ? item.texto : item.articulo.nombre }}</span>
              </template>
              <template v-slot:item.cantidad="{ item }">
        ...
        <template v-slot:item.rentabilidad="{ item }">
          <span>$ {{ formatoImporte(item.rentabilidad) }}</span>
        </template>
        <template v-slot:item.importedescuento="{ item }">
          <span>$ {{ formatoImporte(item.importedescuento) }}</span>
        </template>
        ...
        <template v-slot:item.observaciones="{ item }">
          <span>{{ item.observaciones=='PEDIDO DEL CLIENTE' ? 'Cliente' : 'Vendedor' }}</span>
        </template>
        <template v-slot:item.estado="{ item }">
  ...
  computed: {
    ...
    laDireccion () {
      if (this.itemActual.user) {
        let dir = this.itemActual.user.tercero.direcciones[0].direccion + ' ('
      ...
      .then(({ data }) => {
        ...
        if (val !== null && val !== '') {
          ...
          return HTTP().get('/tercero/'+valor).then(({ data }) => {
            ...
            this.reglas = []
            let tagsDelTer = []
//            return HTTP().get('/leoelusertercero/'+this.userId+'/'+this.editado.tercero_id).then(({ data }) => {
//              if (data!=0) {
  
                return HTTP().post('/tercerotags', { userterceroid: this.userDelTerceroDatos[0].id }).then(({data})=>{
                  for (let i=0; i<=data.length-1; i++) {
...
//                        for (let i=0; i<=tmpTer.length-1; i++) {
                          if (Number(data.reglas[i].tagster)!=0) {
                            tmpTerAp.push(Number(data.reglas[i].tagster))
                          }
//                        }
...
//                          cttminima: data.reglas[i].cttminima,
                            tagsPre: Number(data.reglas[i].tagspre)
                          })
                        }
                      }
                    }
...
//            })
    ...
    searchTercerosTrans (val) {
      ...
      return HTTP().get('/userstransportistas/false/4').then(({ data }) => {
    ...
    searchTercerosPdr (val) {
      ...
      return HTTP().get('/userspuntosderetiros/false/5').then(({ data }) => {
    ...
    searchTercerosPdrDir (val) {
      ...
      return HTTP().get('/userspuntosderetiros/'+this.envio.direccion_id+'/'+this.envio.puntoderetiro_id).then(({ data }) => {
      ...
      this.leoAnios().then(data => {
        if (this.externo) {
          ...
          if (this.centrales.ventas_panel=='') {
            this.$store.commit("setCentrales", { ventas_panel: this.sucursalDemo ? 'Presup.' : 'Facturas' }, { root: true });
          }
          if (this.sucursalDemo) {
...
*/
    ...
    cargoSaldosYValoresPendientes(tercero) {
      ...
      return HTTP().get('/saldo/'+tercero).then(({ data }) => { 
        ...
        return HTTP().get('/valorespendientes/'+tercero).then(({ data }) => { 
          if (data[0]) {
...
*/
      let txt = ''
      if (item.vinculoHijo.length>0) {
        txt = item.vinculoHijo[0].padre.cpr+'<br>'
      }
      if (item.vinculoPadre.length>0) {
        txt += item.vinculoPadre[0].hijo.cpr
      }
      return txt
    ...
    setAcciones(item) {
      ...
      if (item.cpr.substr(0,3)=='PED') {
        if (this.operarioVendedor) {
          if (item.observaciones=='PEDIDO DEL VENDEDOR') {
          ...
          if (item.observaciones=='PEDIDO DEL CLIENTE') {
            if (item.estado!='T' && item.estado!='P' && item.estado!='E' && item.estado!='B') {
              this.acciones.push({nombre: 'Anular', icon: 'mdi-backup-restore'})
            }
          }
...
//            }
        ...
        if (item.estado=='L' || item.estado=='R' || (item.estado=='P' && !this.operarioVendedor)) {
          this.acciones.push({nombre: 'Modificar Pedido', icon: 'mdi-playlist-check'})
          if (this.sucursales.length>1 && item.observaciones!='PARTICIONADO') {
            this.acciones.push({nombre: 'Transferir a otra Sucursal', icon: 'mdi-file-document'})
          }
...
*/      
    ...
    anularRecibo(item) {
      return HTTP().get('/controlanularrecibo/'+item.id ).then(({ data }) => {
    ...
    aEmbalajeHTTP(item) {
      ...
      return HTTP().post('/pedidoaembalaje', { pedido: item, novedad: novedad }).then(({ data }) => {
    ...
    aPedidosEmbaladosHTTP() {
      return HTTP().post('/pedidosembalados', { embalados: this.aEmbalar }).then(({ data }) => {
        if (data) {
          this.dialogEmbalajes = false
          this.embalajesSel = 0
          this.listarHTTP(false)
    ...
    pedidosAEmbalajeHTTP() {
      return HTTP().post('/pedidosaembalajetransfiere', { pedidosaembalaje: this.pedidosAEmbalaje }).then(({ data }) => {
        if (data) {
          this.dialogPedidosAEmbalaje = false
          this.embalajesSel = 0
          this.listarHTTP(false)
        }
      })
    ...
    enviarPedidoDelVendedor(item) {
      ...
      if (this.items[this.editedIndex].tercero.user) { // esta modificando
        ...
        return HTTP().patch('/enviarpedido', {id: this.items[this.editedIndex].id,novedad: novedad,vendedor: true }).then(({ data })=>{
          if (data = 'ok') {
            for (let i=0; i<=item.items.length-1; i++) {
    ...
    confirmarPedidosAEmbalaje() {
      if (this.embalajesSel==1) {
        this.msg.msgTitle = 'PEDIDO A EMBALAJE'
        this.msg.msgBody = '¿Confirma enviar este Pedido a Embalaje?'
      } else {
        this.msg.msgTitle = 'PEDIDOS A EMBALAJE'
        this.msg.msgBody = '¿Confirma enviar los '+this.embalajesSel+' Pedidos seleccionados a Embalaje?'
      }
      this.msg.msgVisible = true
      this.msg.msgAccion = 'pedidos a embalaje'
      this.msg.msgButtons = ['Aceptar','Cancelar']
    },
...
//    this.isLoadingTerceros = true
      ...
      for (let i=0; i<=item.items.length-1; i++) {
        this.articulos.push({ 
          ...
          moneda_id:        item.items[i].articulo.moneda_id,
          iva_id:           item.items[i].articulo.iva_id,
          ivatasa:          item.items[i].articulo.iva.tasa,
          cantidad:         Number(item.items[i].cantidad),
          cantidadoriginal: Number(item.items[i].cantidad),
          stock:            Number(item.items[i].cantidad),
          undstock:         Number(item.items[i].cantidad),
...
//        this.listarAnotaciones()
        ...
        return HTTP().get(`/estaenusertercero/${que.tercero_id}`).then(({ data }) =>{
          if (!data) {
            ...
            return HTTP().get('/tercero/'+que.tercero_id).then(({data}) => {
              if (data[0].vendedor!=undefined) {
                this.editado.vendedor = data[0].vendedor
              }
              ...
              return HTTP().post('/actualizocostosdelpedidoparafacturar', { arts: arts }).then(({ data }) => {
                ...
                for (let i=0; i<=que.items.length-1; i++) {
                  if (que.items[i].cantidad!=0) {
                    ...
                    this.articulos.push({ 
                      ...
                      ivatasa:          que.items[i].articulo.iva.tasa,
    ...
    seleccionarPedidoAEmbalaje(item) {
      item.seleccionado = !item.seleccionado
      this.embalajesSel = 0
      for (let i=0; i<=this.pedidosAEmbalaje.length-1; i++) {
        if (this.pedidosAEmbalaje[i].seleccionado) {
          this.embalajesSel ++
        }
      }
    },
    ...
    embalajes() {
      ...
      this.aEmbalar = []
      return HTTP().post('/leerembalajes', { suc: this.sucursal, grp: this.grpEmbalaje }).then(({ data }) => {
        if (data.length>0) {
          if (this.grpEmbalaje=='Sin agrupar') {
            let cpr1 = ''
            let cpr2 = ''
    ...
    pedidosFacturadosAEmbalaje() {
      this.dialogPedidosAEmbalaje = true
      this.pedidosAEmbalaje = []
      this.embalajesSel = 0
      return HTTP().post('/pedidosaembalaje', {}).then(({ data }) => {
        for (let i=0; i<= data.length-1; i++) {
          this.pedidosAEmbalaje.push({
            cpr_id: data[i].cprid,
            fecha: data[i].fecha,
            cpr: data[i].cpr,
            nomcli: data[i].nombre,
    ...
    prepararEnvioRetiro(item, cual) {
      ...
      return HTTP().get('/tercero/'+item.tercero.id).then(({ data }) => {
        this.dirItems = []
        for (let i=0; i<= data[0].tercero.direcciones.length-1; i++) {
          this.dirItems.push(data[0].tercero.direcciones[i])
        }
    ...
    irAlRemito(item) {
      return HTTP().get('/buscoremitovinculado/'+item.id ).then(({ data }) => {
        if (data) {
          this.selectTipoDeComprobante('Remitos')
        }
      })
    },
        ...
        return HTTP().get('/ventasitems/'+this.anotadorId).then(({data})=> {
          ...
          for (let i=0; i<=data.length-1; i++) {
            this.articulos.push({ 
              ...
              ivatasa:          data[i].articulo.iva.tasa,
...
//        this.editado.documentoCodigo = this.itemActual.tercero.documento.codigo
        ...
        return HTTP().post('/recibo', { editado }).then(({ data }) => {
          if (data=='error') {
              ...
              if ( this.electronica) {
                if (data.cpr==undefined) {
                  ...
                  if (this.notificaEnBaseAOtro.length) {
                    msg += '¡El comprobante ha sido enviado al cliente y ya esta notificado!'
                  }
                  this.msg.msgBody    = msg
      ...
      for (let i=0; i<=this.articulos.length-1; i++) {
        ...
        if (pos>=0) {
          ...
          this.ivas.push({
            ...
            BaseImp: this.roundTo(totitem,2),
            Importe: this.roundTo(totitem*(this.ivaTasas[posiva].tasa/100),2)
          })
        }
      }
    },
    ...
    cprBalanceado() {
      ...
      let control = this.roundTo(((valores+cancelado+Number(this.editado.total))/3),2)
      if (this.roundTo(((valores+cancelado+Number(this.editado.total))/3),2)!=this.roundTo(this.editado.total,2)||this.editado.total==0) {
        return false
      } else {
        return true
      }
...
//      this.valDiferencia = this.roundTo((Number(this.editado.total))-(totPen-totVal),2) 
//      this.valDiferencia = this.roundTo(totPen-totVal,2) 
        this.valDiferencia = this.roundTo((Number(this.editado.total)+(this.recargo))-totVal,2) 
      } else {
        this.valDiferencia = this.roundTo((Number(this.editado.total)+(this.recargo))-totVal,2) 
      }
    },
    ...
    totalComprobante(conRecargos) { // calculo el total a pagar del comprobante y actualizo todos los edit
      let des = 0; let gra = 0; let exe = 0; let iva = 0; let tas = 0; let tot = 0; let base = 0; let posiva = 0;
      for(let i=0; i<=this.articulos.length-1; i++) {
        if (conRecargos) {
        ...
        if (this.articulos[i].iva_id==2) {
          ...
          if (this.sucursalDemo) {
            ...
            iva = this.truncTo((base*(1+(tas/100)))-base,2)
          }
        }
        tot += exe+gra+iva
      }
    ...
    calculos() {
      let gra = 0; let exe = 0; let iva = 0; let tas = 0; let des = 0; let posiva = 0
      ...
      if (this.articulos.length>0) {
        ...
        let recargo = 0
        for(let i=0; i<=this.articulos.length-1; i++) {
          recargo = this.articulos[i].total*(this.articulos[i].tasaproprecargo/100)
          base = this.articulos[i].total+recargo
          if (this.editado.tasadescuento>0) {
            des = this.roundTo(base*(Number(this.editado.tasadescuento)/100),2)
            base = this.roundTo(base - des,2)
          }
          if (this.articulos[i].iva_id==2) {
            ...
            if (this.sucursalDemo) {
              ...
              iva = this.truncTo(base*(tas/100),2)
            }
          }
          this.rentabilidad += 
        ...
        for (let i=0; i<=this.itemActual.items.length-1; i++) {
          ...
          if (this.itemActual.items[i].cantidad != 0) {
            this.articulos.push({
              ...
              ivatasa:          this.itemActual.items[i].articulo.iva.tasa,
...
*/
    ...
    chequearTransfPed(item) {
      ...
      return HTTP().post('/releercomprobante', { id: item.id }).then(({ data }) => {
        ...
        return HTTP().get('/buscocomprobantesvinculados/'+item.id ).then(({ data }) => {
          let disp = []
          if (data.length>0) {
            for (let i=0; i<=data.length-1; i++) {
    ...
    editarArt(item) {
      ...
      this.busArt = this.articulos[this.editedIndexArt].codigo
      this.$refs.cantidad.focus()
    },
    ...
    sumarRestar(item, cuanto, api, array) {
      ...
      if (api) {
        ...
        if (array=='articulos') {
          this.articulos[k].cantidad += cuanto
          this.actualizoItem(this.articulos[k].cantidad, this.articulos[k].precio, true)
//        this.articulos[k].total = this.articulos[k].precio*this.articulos[k].cantidad
          this.calculos()
        } else if (array=='pedidos') {
    ...
    buscarArt(estricto) {
      ...
      // si es PED es porque es el usuario es un Vendedor, y vinculosPadres viene cargado solo con la
      // empresa del mismo.
      v = this.$store.state.vinculosPadres

      let data1 = null
      return HTTP().post('/userarticulosfac', {search: b, vinculos: v, estricto: estricto, userex:this.userId}).then(({data})=>{
        ...
        return HTTP().post('/buscolaregla', {
          ...
          this.cttminima = 1
          this.promoDescuento = data1[0].pubtasdes ? data1[0].pubtasdes : 0
          ...
          if (data1[0].pubprecio && data1[0].pubestado!='U' && data1[0].pubunidades!=0 && this.reglaDescuento<this.promoDescuento) {
            descual = 'Promocion'
          }
          ...
          if (data1.length==1) {
            let impdes = this.roundTo((data1[0].precio*this.editadoArt.cantidad)*(pordes/100),data1[0].decimales)
            ...
            this.editadoArt.codbar           = data1[0].codbar;
            this.editadoArt.unidad_id        = data1[0].unimedid
            this.editadoArt.moneda_id        = data1[0].monedaid
            this.editadoArt.iva_id           = data1[0].ivaid
            this.editadoArt.monedaNombre     = data1[0].simbolo
            this.editadoArt.unidadNombre     = data1[0].unimed
            this.editadoArt.ivaNombre        = data1[0].tasa+'%'
            this.editadoArt.costoanterior    = this.roundTo(data1[0].costo,data1[0].decimales)
            this.editadoArt.costo            = this.roundTo(data1[0].costo,data1[0].decimales)
            this.editadoArt.precio           = this.roundTo(data1[0].precio,data1[0].decimales)
            this.editadoArt.preciooriginal   = this.roundTo(data1[0].precio,data1[0].decimales)
            this.editadoArt.decimales        = data1[0].decimales
            this.editadoArt.tasadescuento    = pordes
            this.editadoArt.importedescuento = impdes
            this.editadoArt.total            = this.roundTo((this.editadoArt.precio*this.editadoArt.cantidad)-impdes,data1[0].decimales)
            this.editadoArt.deposito_id      = this.depItems[0].id
            this.editadoArt.stock            = data1[0].stock
            this.editadoArt.undstock         = data1[0].undstock
            this.editadoArt.texto            = descual
            this.editadoArt.pubprecioori     = 0
            ...
            if (descual=='Promocion') {
              this.editadoArt.pubprecioori     = data1[0].pubprecio
              this.editadoArt.pubprecio        = data1[0].pubprecio
              this.editadoArt.pubtasdes        = data1[0].pubtasdes
              this.editadoArt.pubenvio         = data1[0].pubenvio
              this.editadoArt.pubunidades      = data1[0].pubunidades
              this.editadoArt.pubestado        = data1[0].pubestado
              this.editadoArt.importedescuento = this.roundTo(data1[0].costo-data1[0].pubprecio,2)
              this.editadoArt.tasadescuento    = data1[0].pubtasdes
//            this.editadoArt.costoanterior    = data1[0].pubprecio
              this.editadoArt.costo            = data1[0].pubprecio
              this.editadoArt.total            = data1[0].pubprecio
            }
    ...
    cantidadItem() {
      ...
      this.precioOrigen = 'Lista'
      this.cttminima = 1
      this.promoDescuento = this.editadoArt.pubtasdes
      this.reglaDescuento = 0
      this.unidadesRegla = this.editadoArt.unidadesRegla
      ...
      // QUE DESUENTO TOMO?, puede ser el de la regla o el de la promo, el que sea mayor
      if (this.editadoArt.pubprecio && this.editadoArt.pubestado!='U' && this.editadoArt.pubunidades!=0 &&
          this.reglaDescuento<this.promoDescuento && this.editadoArt.pubunidades>this.editadoArt.cantidad) {
        descual = 'Promocion'
      }
...
/*
    // VER ESTO!!!, PUEDE EL USUARIO CAMBIAR EL RPECIO DELSDE EL FORMULARIO?, SUPUESTAMENTE NO, PERO QUIZAS SI.
    precioItem() {
...
*/
    ...
    guardarItem(columna) {
      ...
      // QUE DESUENTO TOMO?, puede ser el de la regla o el de la promo, el que sea mayor
      if (this.editadoArt.pubprecio && this.editadoArt.pubestado!='U' && this.editadoArt.pubunidades!=0 &&
          this.reglaDescuento<this.promoDescuento) {
        descual = 'Promocion'
      }
      ...
      if (txt.substring(0,5)=='Regla' && ctt < this.cttMinima) {
        txt = 'Regla no alcanzada'
        this.editadoArt.texto = txt
        if (this.editado.cpr.substring(0,3)==='PED') {
          this.mensaje('Si incluyes '+this.cttMinima+' unidades o más obtendrás un descuento del '+this.reglaDescuento+'%', this.temas.forms_titulo_bg, 5000)
        }
      }
      ...
      } else if (txt.substring(0,5)=='Regla') {
        this.actualizoItem(ctt-this.editadoArt.pubunidades, pre, false)
      } else {
        this.actualizoItem(ctt, pre, false)
      }
    ...
    actualizoItem(ctt, pre, actualizo) {
      ...
      if (txt.substring(0,5)=='Regla' && ctt>=this.cttMinima) {
        ...
        if (actualizo) {
          this.articulos[this.editedIndexArt].texto = (ctt>=this.cttMinima) ? 'Regla' : 'Lista'
        } else {
          this.editadoArt.texto = (ctt>=this.cttMinima) ? 'Regla' : 'Lista'
        }
      } else if (txt=='Promocion') {
        pordes = this.promoDescuento
      } else if (txt=='Lista') {
      ...
      if (!actualizo) {
        this.articulos.unshift({
          ...
          undenvase:        null,
          escombo:          false,
          unidadesRegla:    this.editadoArt.unidadesRegla
        })
      } else {
    ...
    guardarArtAnotador(item) {
      ...
      if (this.editedIndexArt > -1) { // esta modificando
        ...
        this.articulos[this.editedIndexArt].unidadesRegla    = this.editadoArt.unidadesRegla
      } else {
        let estaba = false
        for (let i=0; i<=this.articulos.length-1; i++) {
    ...
    aplicarPorcentajeATransferir() {
      ...
      for (let i=0; i<=this.artTransfPed.length-1; i++) {
        atr = this.artTransfPed[i].cttori*(this.artTransfPorcentaje/100)
    ...
    guardarTransfPed(item) {
      return HTTP().post('/transfieropedido/'+this.itemActual.id, 
        { sucursales: this.sucursales, sucursal: this.artTransfPedId,
          itemactual: this.itemActual, articulos: this.artTransfPed })
        .then(({ data }) => {
    ...
    msgRespuesta(op) {
      if (op==='Aceptar') {
        ...
        } else if (this.msg.msgAccion=='pedidos a embalaje') {
          this.pedidosAEmbalajeHTTP()
    ...
    chequearAfip () {
      return HTTP().post('chequearafip', {cuit: this.datosEmpresa.cuit, produccion: this.datosEmpresa.faeproduccion })
      .then((res) => {
